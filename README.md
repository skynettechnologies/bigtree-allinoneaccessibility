# All in One Accessibility®: BigTree CMS Plugin
...
- From the top navigation, go to "Developer >> Extenisons >> Install Extension", and upload plugin zip.
- Click Install to get started.
- Now, go to "View Extensions" Tab and in the plugin list, you will see All in One Accessibility.

3. Configure the Plugin

- After installation, Go to "Modules", There you can see the All in One Accessibility.
- Click it to open the settings page and manage plugin options.
